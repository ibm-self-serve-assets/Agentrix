...
async def generate(input_text: str) -> str:
    ...
    from src.agents.get_weather_agent import get_beeai_framework_agent, observer
    ...
    # woremarks_prompt= f""" Here is the weather forecast:
    #                             {weather_summary}. convert this into sentence and 
    #                     Please update the summury to workorder remarks."""
    
    # remark_response = await agent.run(
    # woremarks_prompt,
    # execution=AgentExecutionConfig(
    ...
    # update_summary = '\n'.join([m.text for m in remark_response.result.content])
    # print("final summary after all agents = ",update_summary)
